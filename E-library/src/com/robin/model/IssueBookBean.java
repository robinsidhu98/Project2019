...
public String toString() {
	return "IssueBookBean [callno=" + callno + ", studentid=" + studentid + ", studentname=" + studentname
			+ ", studentmobile=" + studentmobile + ", issueddate=" + issueddate + ", returnstatus=" + returnstatus
			+ "]";
}
